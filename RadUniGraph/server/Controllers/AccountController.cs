...
namespace UniBlocksGraph
{
    public partial class AccountController : Controller
    {
        ...
        public async Task SendConfirmationEmail(UserManager<ApplicationUser> userManager, ApplicationUser user, IUrlHelper url, string scheme)
        {
            ...
            await SendEmail(user, code, callbackUrl, "Welcome to UniBlocks, Please confirm your email address ", "Welcome to UniBlocks, Please confirm your email address ");
        }
        ...
        public async Task SendEmail(ApplicationUser user, string code, string callbackUrl, string subject, string text)
        {
            ...
            client.Credentials = new System.Net.NetworkCredential("minipossender@gmail.com", "sS12345678");

            var mailMessage = new System.Net.Mail.MailMessage();
            mailMessage.From = new System.Net.Mail.MailAddress("minipossender@gmail.com");
